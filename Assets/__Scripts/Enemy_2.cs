...
public class Enemy_2 : Enemy // Enemy_2 also extends the Enemy class
{
    ...
    [Tooltip("Determines how much the Sine wabe will ease the interpolation")]
    ...
    void Start()
    {
        ...
        // Set the birthTiem tot he current time
        birthTime = Time.time;
    ...
    public override void Move() {
        ...
        // If u>1, thn it has been longer than lifeTime since birthTime
        if (u > 1) {
        ...
        // Note that Enemy does NOT call the base.Move() method
    }
}
