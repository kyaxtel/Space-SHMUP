...
public class Enemy_4 : Enemy                // Enemy_4 also extend the Enemy class
{  
    ...
    void InitMovement() {
        ...
        // Assign a new on-screen loaction to p1
    ...
    public override void Move() {
        // This comletely overrides Enemy.Move() with a linear interpolation
    ...
    void OnCollisionEnter(Collision coll) 
    {
        ...
        if ( p != null ) {
            ...
            if ( bndCheck.isOnScreen ) {
                ...
                // Find the EndmyShield that was hit (if there was one)
            ...
            Debug.Log( " Enemy_4 hti by non-projectileHero: " + otherGO.name);
        }
    }
